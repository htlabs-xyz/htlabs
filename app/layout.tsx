  ...
  return (
    ...
    >
      ...
      <link
        ...
        type="image/png"
        sizes="32x32"
        href={`${siteMetadata.siteUrl}/static/favicons/favicon-32x32.png`}
      />
      <link
        rel="icon"
        type="image/png"
        sizes="16x16"
        href={`${siteMetadata.siteUrl}/static/favicons/favicon-16x16.png`}
      />
      <link rel="manifest" href={`${siteMetadata.siteUrl}/static/favicons/site.webmanifest`} />
      <link
        rel="mask-icon"
        href={`${siteMetadata.siteUrl}/static/favicons/safari-pinned-tab.svg`}
        color="#5bbad5"
      />
